 ...
 * Test TLN_Normalizer using PCRE in singe-byte (non-UTF-8) mode.
 */
 ...
 */
class Tests_TLN_Normalizer_No_UTF8 extends WP_UnitTestCase {
	...
	public static function wpSetUpBeforeClass() {
		...
		$tlnormalizer->no_pcre_utf8 = true;
    ...
    public function test_is_normalized() {
		global $tlnormalizer;
		$this->assertFalse( $tlnormalizer->using_pcre_utf8 );
