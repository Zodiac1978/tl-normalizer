#!/usr/bin/env bash
# https://github.com/stephenharris/Event-Organiser/blob/develop/bin/install-wp-tests.sh
...
WP_TESTS_DIR=${WP_TESTS_DIR-/var/www/wordpress-develop/tests/phpunit}
WP_CORE_DIR=/var/www/wordpress-develop/
